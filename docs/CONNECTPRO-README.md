# 🎉 ConnectPro - Professional Communication Platform
...
1. Run `npm run dev` in the root folder of the project.
2. Wait for both servers to start.
3. Open `http://localhost:5173` and login with: `test@example.com` / `password123`.
